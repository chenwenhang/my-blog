...
今年一志愿报考东南大学计算机学院计算机技术专硕，分数线350，未达线，选择调剂到苏州联合研究生院。
...
东南大学考研，复试起到决定性作用，复试分数权值大于初试。一定要好好把握！

#### 英语测试

由于计算机院分数不够，最终调剂到苏州联合研究生院，学院需要对学生英语水平进行测试，不难，听力部分这样的：一段内容先听一遍，然后五个选词填空，再听一遍五个选择题。一共两段听力，题目都是写在试卷上的。接着是55道选择题35分钟内写完，时间很紧。许多同学最后的阅读都没时间看直接选的，总体上不难，不要过分纠结一题。作文20分钟，A和B题目二选一，18、19都有话题作文，19年有一题是谈谈出生率下降这件事情，这种议论文都有模版可循的，主要是要多写，20分钟真的很紧，提前要准备准备。最终计算机总共120人被刷了20人，比前几年刷的多了很多。

#### 笔试

复试553C++程序设计，难度尚可，把郑莉那本C++认真看几遍，一字不落，每章的深度探索可以不看，以及STL和异常也几乎不考。18、19年越来越重实际写代码的能力，19年没考概念题，十道读代码写结果，不难但很绕人，一题十分，一道程序改错十分，三道编程10+10+20共30分，对于科班出身，并且大学参加过蓝桥杯、ACM的同学来说不算难，但是要谨防陷阱题，注意抓住书上的每一个知识点，例如前几年就考过32位机器上输出各个类型所占字节数、`const int*`和`int* const`的区别，大家不要麻痹大意。对于跨考的同学可能有难度，看到出成绩有很多跨考的未及格，这意味这取消资格。

#### 面试

苏州联合研究生院的面试是纯英文，需要提前准备好内容。我于复试前准备了英文自我介绍，一定要背到条件反射不用动脑子的地步，脱口而出的那种，防止现场紧张说不出话。有项目有获奖的同学最好做份简历带过去，同时准备相关英文描述。今年老师大致问了我：1.简单介绍下这个XXX项目。2.你在其中负责什么内容。3.那你是怎么优化数据库的。4.你认为软件工程这门课在大学开设是否有必要。5.兴趣、学校方面的问题。老师们都很和蔼，笑着看你，不用太紧张，基本就像平时跟长辈聊天一样，放开自己，把最好的一面展现出来。招研究生不是招书呆子，更不是招三观有问题，用鼻孔看人的人，请各位好好把握。
